...
public class RobotBHead extends GameObject implements Recyclable {
    ...
    public static RobotBHead get(float x, float y)
    {
//        GameWorld2 gw = GameWorld2.get();
//        RobotBHead robotAHead = (RobotBHead)gw.getRecyclePool().get(RobotBHead.class);
//        if(robotAHead == null) {
//            robotAHead = new RobotBHead();
//        }
        RobotBHead robotAHead = new RobotBHead();

        robotAHead.fab = new FrameAnimationBitmap(R.mipmap.robot_objb_head, FRAME_PER_SECOND, FRAME_COUNT);
